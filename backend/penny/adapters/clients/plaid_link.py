...
TOKEN_FILE_PATH = "/tmp/penny_plaid_token"  # noqa: S108, S105
LINK_TOKEN_FILE_PATH = "/tmp/penny_plaid_link_token"  # noqa: S108, S105
...
def _create_ssl_context() -> ssl.SSLContext:
    ...
    """
    # Navigate from src/penny/adapters/clients/ to project root
...
def create_link_token_and_url(
    *,
    ...
    """
    user_id = f"penny-user-{uuid.uuid4()}"
