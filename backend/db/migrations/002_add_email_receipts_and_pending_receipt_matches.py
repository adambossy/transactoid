...
Revision ID: 002_add_email_receipts_and_pending_receipt_matches
Revises: 001_add_transaction_items_and_split_columns
...
revision: str = "002_add_email_receipts_and_pending_receipt_matches"
down_revision: str | Sequence[str] | None = (
    "001_add_transaction_items_and_split_columns"
)
