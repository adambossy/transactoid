...
Revision ID: 004_add_account_sign_conventions
Revises: 003_add_refund_columns_to_derived_transactions
...
foreign-key because the plaid_accounts table was dropped in an earlier migration.
...
revision: str = "004_add_account_sign_conventions"
down_revision: str | Sequence[str] | None = (
    "003_add_refund_columns_to_derived_transactions"
)
