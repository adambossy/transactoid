...
This directory contains Alembic configuration for database migrations in the penny project.
...
```bash
export DATABASE_URL="postgresql://user:password@localhost/penny"
# or for SQLite:
export DATABASE_URL="sqlite:///./penny.db"
```
