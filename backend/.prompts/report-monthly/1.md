...
Check if `memory/budget.md` exists. If it does, read it to get monthly budget targets. If the file does not exist, omit all budget comparisons from the report.
...
- If budget data is available: am I on track to meet my monthly target?
