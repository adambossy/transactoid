...
class TransactionFixture:
    ...
    description: str
    plaid_items: list[dict[str, Any]] | None = None
    ...
    "last_month_spending": TransactionFixture(
        ...
        transactions=[
            ...
            _txn(
                ...
                date(2025, 11, 5),
                "Target",
                "shopping_and_personal_care.household_supplies",
            ),
            _txn(
                "txn_017",
                4500,
            ...
            _txn(
                ...
                date(2025, 11, 1),
                "AT&T",
                "housing_and_utilities.mobile_phone",
            ),
            _txn(
                "txn_019",
                6000,
                date(2025, 11, 3),
                "PG&E",
                "housing_and_utilities.electricity",
            ),
            _txn(
                "txn_020",
                8950,
                date(2025, 11, 15),
                "Netflix",
                "entertainment_and_subscriptions.streaming_video",
            ),
            ...
            _txn(
                ...
                date(2025, 11, 16),
                "Uber",
                "transportation_and_auto.rides_and_taxis",
            ),
            _txn(
                "txn_025",
                3200,
            ...
            _txn(
                ...
                date(2025, 11, 20),
                "Bay Area Transit",
                "transportation_and_auto.public_transit",
            ),
            ...
            _txn(
                ...
                date(2025, 11, 17),
                "Amazon",
                "shopping_and_personal_care.electronics_and_gadgets",
            ),
            _txn(
                "txn_037",
                7000,
            ...
            _txn(
                ...
                date(2025, 11, 22),
                "CVS Pharmacy",
                "health_and_wellness.pharmacy_and_prescriptions",
            ),
            _txn(
                "txn_039",
                14000,
            ...
            _txn(
                ...
                date(2025, 11, 25),
                "Spotify",
                "entertainment_and_subscriptions.music_and_audio",
            ),
            _txn(
                "txn_041",
                14550,
                date(2025, 11, 28),
                "Steam",
                "entertainment_and_subscriptions.gaming",
            ),
            _txn(
                "txn_042",
                5050,
                date(2025, 11, 30),
                "AMC Theatres",
                "entertainment_and_subscriptions.hobbies_and_leisure",
            ),
        ],
        ground_truth={
            # Overall
