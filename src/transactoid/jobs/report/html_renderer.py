...
# CSS styles for the spending report HTML
HTML_STYLES = """
:root {
    --primary: #2563eb;
    --primary-dark: #1d4ed8;
...
def render_report_html(markdown_text: str) -> str:
    ...
    prompt = f"""Convert the following markdown spending report into a well-structured HTML document.

Use this CSS (include it in a <style> tag in the <head>):
...
The markdown report to convert:
