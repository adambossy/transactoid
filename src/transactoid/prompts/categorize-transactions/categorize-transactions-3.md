...
The following rules and guidelines govern how transactions should be categorized. Use these rules when helping users understand categorization or when suggesting category updates. Note that these rules use human-readable display names - you must map these to the exact 'key' values from the taxonomy YAML above.
