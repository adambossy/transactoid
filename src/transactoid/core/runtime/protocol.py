...
def classify_tool_kind(tool_name: str) -> ToolCallKind:
    ...
    kind_map: dict[str, ToolCallKind] = {
        ...
        "list_amazon_logins": "execute",
        "add_amazon_login": "execute",
        "update_amazon_login": "execute",
        "remove_amazon_login": "execute",
        "clear_amazon_login_context": "execute",
        "enable_amazon_login": "execute",
        "disable_amazon_login": "execute",
