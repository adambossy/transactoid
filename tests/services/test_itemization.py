"""Tests for the proportionally_allocate helper in services/itemization.py."""

from __future__ import annotations

import pytest

from transactoid.errors import AppError
from transactoid.services.itemization import proportionally_allocate
