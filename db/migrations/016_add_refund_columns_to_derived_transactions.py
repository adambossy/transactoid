...
Revision ID: 016_add_refund_columns_to_derived_transactions
Revises: 015_add_email_receipts_and_pending_receipt_matches
...
Net spend computation:
  Refund rows carry a negative amount_cents. Spend aggregations use
  SUM(amount_cents) directly — refunds subtract naturally. The FK is for
  traceability only, not arithmetic.
...
revision: str = "016_add_refund_columns_to_derived_transactions"
down_revision: str | Sequence[str] | None = (
    "015_add_email_receipts_and_pending_receipt_matches"
)
