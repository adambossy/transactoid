...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_transactions_posted_at", "transactions", ["posted_at"], unique=False
    )
    op.create_index(
        "idx_transactions_merchant_id", "transactions", ["merchant_id"], unique=False
    )
    op.create_index(
        "idx_transactions_category_id", "transactions", ["category_id"], unique=False
    )
    op.create_index(
        "idx_transactions_is_verified", "transactions", ["is_verified"], unique=False
    )
    op.create_index(
        "idx_transactions_external_source",
        "transactions",
        ["external_id", "source"],
        unique=False,
    )
