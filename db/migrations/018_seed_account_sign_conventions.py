...
Revision ID: 018_seed_account_sign_conventions
Revises: 017_add_account_sign_conventions
...
mapping in transactoid.adapters.db.sign_convention_defaults.
...
revision: str = "018_seed_account_sign_conventions"
down_revision: str | Sequence[str] | None = "017_add_account_sign_conventions"
...
def upgrade() -> None:
    ...
    from transactoid.adapters.db.models import (  # noqa: PLC0415
        AccountSignConvention,
        PlaidTransaction,
    )
    from transactoid.adapters.db.sign_convention_defaults import (  # noqa: PLC0415
