...
| 2b | [BYO keys & metered subsidy](../specs/2026-07-03-phase-2b-byo-keys-metered-subsidy-design.md) | 2 (+ agent-harness) | **Planned** ([spec](../specs/2026-07-03-phase-2b-byo-keys-metered-subsidy-design.md) · [plan](2026-07-03-phase-2b-byo-keys-metered-subsidy.md)); migrations 020/021. **Prerequisite for phase 4** open signup (spend cap) |
| 0 | [Design system (`@penny/ui`)](2026-07-03-phase-0-design-system.md) | — | **Planned** ([spec](../specs/2026-07-04-phase-0-design-system-design.md) · [plan](2026-07-04-phase-0-design-system.md)); precedes UI phases 2/4/5 |
| 3 | [Production cutover & legacy-data migration](2026-06-27-phase-3-provision-and-test.md) *(repurposed)* | 1a, 1b, 2, **4** (handoff) | **Planned** ([spec](../specs/2026-07-03-phase-3-cutover-design.md) · [plan](2026-07-03-phase-3-cutover.md)); non-canonical `backend/transient/`. Old provision+test docs superseded (provisioning→4, validation→6) |
