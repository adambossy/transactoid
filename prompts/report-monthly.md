...
Generate a comprehensive spending report for {{CURRENT_MONTH}} {{CURRENT_YEAR}}.

## Your Budget Targets

These are my monthly budget targets by category:

- **Housing**: $2,500/month (rent, utilities, maintenance)
- **Food**: $800/month total
  - Groceries: $500/month
  - Restaurants/Dining: $300/month
- **Transportation**: $400/month (gas, parking, transit, rideshare)
- **Health & Fitness**: $200/month (gym, supplements, medical)
- **Entertainment**: $150/month (streaming, movies, games)
- **Shopping**: $200/month (clothing, electronics, household)
- **Personal Care**: $100/month (haircuts, toiletries)
- **Subscriptions**: $100/month (software, memberships)

**Total Monthly Budget Target**: $4,450/month
...
- Any category where spending is 50% or more above the 3-month average
- Duplicate charges from the same merchant on the same day

## My Financial Goals & Priorities

- **Primary goal**: Keep total monthly spending under $5,000
- **Savings target**: $1,000/month to savings
...
### 3. Spending Trends (3, 6, and 12 months)
...
- **Recurring subscriptions/bills**: What's due in the next 30 days?
- **Seasonal patterns**: Based on the same time last year, what should I expect?
- **Annual expenses approaching**: Insurance, memberships, etc.
